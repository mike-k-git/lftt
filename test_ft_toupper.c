...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/16 13:14:04 by mkugan            #+#    #+#             */
/*   Updated: 2025/05/19 13:52:59 by mkugan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "tests.h"

typedef struct s_ft_toupper_test {
	const char *name;
	int	c;
} t_ft_toupper_test;
...
void	test_ft_toupper(int verbose)
{
	...
	{
		total = total + 1;
		int	result = ft_toupper(tests[i].c);
		int	expected = toupper(tests[i].c);
