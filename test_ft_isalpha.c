...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/16 12:17:44 by mkugan            #+#    #+#             */
/*   Updated: 2025/05/19 12:46:17 by mkugan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "tests.h"

typedef struct s_ft_isalpha_test {
	const char *name;
	int	c;
} t_ft_isalpha_test;
...
void	test_ft_isalpha(int verbose)
{
	...
	{
		total = total + 1;
		int	result = ft_isalpha(tests[i].c);
		int	expected = isalpha(tests[i].c);
