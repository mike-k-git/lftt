...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/16 12:55:52 by mkugan            #+#    #+#             */
/*   Updated: 2025/05/19 12:49:12 by mkugan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "tests.h"

typedef struct s_ft_isdigit_test {
	const char *name;
	int	c;
} t_ft_isdigit_test;
...
void	test_ft_isdigit(int verbose)
{
	...
	{
		total = total + 1;
		int	result = ft_isdigit(tests[i].c);
		int	expected = isdigit(tests[i].c);
